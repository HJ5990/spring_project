...
import com.kh.ajax.ajax.model.vo.Member;
	...
	*/
	...
	@RequestMapping(value="ajax1.do", produces="application/json; charset=UTF-8")
  	public String ajaxMethod1(String name, int age)  {
		...
		list.add(new Member("user01", "pass01", name, age, "01022224441"));
		list.add(new Member("user02", "pass02", name, age, "01022224442"));
		list.add(new Member("user03", "pass03", "김개똥", 15, "01022224442"));
		list.add(new Member("user04", "pass04", name, age, "01022224444"));
		list.add(new Member("user05", "pass05", name, age, "01022224445"));
