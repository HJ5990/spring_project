             ...
             <script>
                function postFormSubmit(num){
                    if(num === 1){
                        ...
                        // document.querySelector("#postForm").setAttribute('action', 'delect.bo');
                    }
                    $("#postForm").submit();
            ...
            function selectReplyList(){
                $.ajax({
                    ...
                    success: function(list){
                        let str = "";
                        for (reply of list){
                            str += ("<tr><th>" + reply.replyWriter + "</th><td>"+reply.replyContent+"</td><td>"+reply.createDate+"</td></tr>");
                        }
                        document.querySelector('#replyArea tbody').innerHTML = str;
                        document.querySelector('#rcount').innerHTML = list.length;
                    },
                    error: function(){
                        console.log("rlist.bo ajax 통신실패")
                    }
                })
            }
